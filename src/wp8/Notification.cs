...
namespace WPCordovaClassLib.Cordova.Commands
{
    public class Notification : BaseCommand
    {
        ...
        public void register(string options)
        {
            ...
            {
                this.DispatchCommandResult(new Notification(Notification.Status.JSON_EXCEPTION));
                return;
            }
            ...
            if (pushChannel == null)
            {
                ...
                {
                    this.DispatchCommandResult(new Notification(Notification.Status.ERROR, InvalidRegistrationError));
                    return;
                }
            ...
            this.DispatchCommandResult(new Notification(Notification.Status.OK, result));
        }
        ...
        public void unregister(string options)
        {
            ...
            if (pushChannel != null)
            {
                ...
                pushChannel.Close();
                pushChannel.Dispose();
                this.DispatchCommandResult(new Notification(Notification.Status.OK, "Channel " + unregisterOptions.ChannelName + " is closed!"));
            }
            else
            {
                this.DispatchCommandResult(new Notification(Notification.Status.ERROR, MissingChannelError));
            }
        }

...
public class NotificationWrapper {
    ...
    static final String PREF_KEY = "Notification";
     ...
     */
    protected NotificationWrapper(Context context, Options options,
    ...
    /**
     * NotificationWrapper type can be one of pending or scheduled.
     */
    public Type getType () {
    ...
    public void schedule() {
        ...
        // Intent gets called when the NotificationWrapper gets fired
    ...
    private void showNotification () {
        ...
        if (Build.VERSION.SDK_INT <= 15) {
            // NotificationWrapper for HoneyComb to ICS
            getNotMgr().notify(id, builder.getNotification());
        } else {
            // NotificationWrapper for Jellybean and above

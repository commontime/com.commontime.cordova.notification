 ...
 */
public class TriggerReceiver extends com.commontime.plugin.notification.notification.TriggerReceiver {
     ...
     */
    @Override
    public void onTrigger (NotificationWrapper notification, boolean updated) {
        super.onTrigger(notification, updated);

        if (!updated) {
            Notification.fireEvent("trigger", notification);
        }
    }
    ...
    public NotificationWrapper buildNotification (Builder builder) {
        return builder
                ...
                .setActionClickActivity(ActionClickActivity.class)

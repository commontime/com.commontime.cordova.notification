 ...
 * shared preferences.
 */
public class ClearReceiver extends com.commontime.plugin.notification.notification.ClearReceiver {
     ...
     */
    @Override
    public void onClear (NotificationWrapper notification) {
        super.onClear(notification);
        Notification.fireEvent("clear", notification);
    }

...
exports.getRegisteredCategories = function (callback, scope) {
    this.core.getRegisteredCategories(callback, scope);
};
 ...
 *      The callback function's scope
 */
exports.removeRegisteredCategories = function (categories, callback, scope) {
    this.core.removeRegisteredCategories(categories, callback, scope);
};
...
exports.setApplicationIconBadgeNumber = function(callback, errorCallback, badge) {
    this.core.setApplicationIconBadgeNumber(callback, errorCallback, badge);
};
...
exports.add = function () {
    console.warn('Depreated: Please use `notification.schedule` instead.');
...
exports.promptForPermission = function () {
    console.warn('Depreated: Please use `notification.registerPermission` instead.');

...
exports.hasPermission = function (callback, scope) {
    ...
    exec(fn, null, 'Notification', 'hasPermission', []);
};
...
exports.registerPermission = function (callback, scope) {
    ...
    exec(fn, null, 'Notification', 'registerPermission', []);
};

/**
 * Get Registered categories (iOS only).
 *
 * @param {Function} callback
 *      The function to be exec as the callback
 * @param {Object?} scope
 *      The callback function's scope
 */
exports.getRegisteredCategories = function (callback, scope) {    
    this.exec('getRegisteredCategories', null, callback, scope);
};

/**
 * Remove registered categories (iOS only).
 *
 * @param {Function} callback
 *      The function to be exec as the callback
 * @param {Object?} scope
 *      The callback function's scope
 */
exports.removeRegisteredCategories = function (callback, scope) {
    ...
    exec(fn, null, 'Notification', 'removeRegisteredCategories');
};

/**
 * Remove all registered categories (iOS only).
 *
 * @param {Function} callback
 *      The function to be exec as the callback
 * @param {Object?} scope
 *      The callback function's scope
 */
exports.clearRegisteredCategories = function (callback, scope) {
...
exports.showToastNotification = function (callback, errorCallback, options) {
    if (typeof callback !== "function")
        return;
    exec(callback, errorCallback, "Notification", "showToastNotification", [options]);
}

// Call this to set the application icon badge
exports.setApplicationIconBadgeNumber = function(callback, errorCallback, badge) {
    if (typeof callback !== "function")
        return;
    exec(callback, errorCallback, "Notification", "setApplicationIconBadgeNumber", [{badge: badge}]);
};
